...
Les feuilles de style ci-dessous sont fournies à titre indicatif. Les étudiants sont libres à les adapter à leurs besoins ou à en utiliser d'autres.

<div class="card-deck">

<div class="card">
  <div class="card-body">
    <h5 class="card-title">Feuille de style pour le mémoire en TAL</h5>
...
<div class="card">
  <div class="card-body">
    ...
    <a class="btn btn-warning" href="/assets/fichiers/Grilles-d-evaluation-Soutenances-TAL-MEMOIRE.pdf" target="_blank">Télécharger</a>
  </div>
</div>
