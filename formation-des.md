...
<p class="h4 text-info">Webinaire de présentation : <strong>lundi 14 septembre 12h-12h30</strong>. Inscrivez-vous via <a href="https://globaldataexcellence.com/inscription-webinaire/" target="_blank">ce formulaire</a></p>. 
...
<div class="card">
  <div class="card-body">
    ...
    <p class="card-text"><ul>
    	<li>Diplôme de Licence, ou équivalent Bac+3 / BSc / VAE.</li>
<li>Aucun prérequis technique n’est demandé pour l’entrée dans la formation.</li>
<li>Le niveau avancé requiert en plus d’avoir suivi la formation DES niveau débutant.</li> 
    </ul></p>
  </div>
</div>
...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Modalités pédagogiques</h5>
    <p class="card-text"><ul>
    	<li>Formation en présentiel.</li>
<li>Théorie interdisciplinaire : informatique, linguistique, gouvernance des données.</li>
<li>Pratique sur DEMS, sans code.</li> 
<li>Pédagogie active : projets en équipe, pédagogie inversée, ateliers pratiques et analyse de maturité des organisations.</li>
<li>Les participants doivent venir avec leur ordinateur portable.</li>
    </ul></p>
  </div>
</div>
...
36 A avenue de l’Observatoire, 25030 Besançon cedex  
Tél. : 03 81 66 61 21  
E-mail : sefocal@univ-fcomte.fr  
Site : [https://sefocal.univ-fcomte.fr/](https://sefocal.univ-fcomte.fr/)
...
<div class="card text-bg-primary">
  ...
  <div class="card-body">
    <p class="card-text">
       <a class="btn" href="/assets/fichiers/DES/Programme FC Data Excellence Science niveau débutant.pdf" target="_blank">Fiche détaillé - DES niveau débutant</a>
</p>

 <p class="card-text">
       <a class="btn" href="/assets/fichiers/DES/SHORT-FORMATION DATA-EXCELLENCE-SCIENCE-BASIQUE UMLP-2026.pdf" target="_blank">Contenu - DES niveau débutant</a>
</p>
  </div>
</div>
...
<div class="card text-bg-primary">
  ...
  <div class="card-body">
    <p class="card-text">
       <a class="btn" href="/assets/fichiers/DES/Programme FC Data Excellence Science niveau avancé.pdf" target="_blank">Fiche détaillé - DES niveau avancé</a>
</p>
 <p class="card-text">
       <a class="btn" href="/assets/fichiers/DES/SHORT-FORMATION DATA-EXCELLENCE-SCIENCE-AVANCE UMLP-2026.pdf" target="_blank">Contenu - DES niveau avancé</a>
</p>
  </div>
</div>
